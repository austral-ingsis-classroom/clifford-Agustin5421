...
public class MyTests {
    @Test
    public void test() {
        FileSystem fileSystem = new FileSystem(Map.of("ls", new LsCommand(), "mkdir", new MkdirCommand(), "touch", new TouchCommand(), "cd", new CdCommand()));
        ...
        assertEquals(fileSystem.executeCommand("mkdir anotherFolder"), "'anotherFolder' directory created");
        fileSystem.executeCommand("ls");
    ...
    @Test
    public void pwdTest(){
        FileSystem fileSystem = new FileSystem(Map.of("ls", new LsCommand(), "mkdir", new MkdirCommand(), "touch", new TouchCommand(), "cd", new CdCommand(), "pwd", new PwdCommand()));
        assertEquals("", fileSystem.executeCommand("ls"));
        assertEquals("'folder1' directory created", fileSystem.executeCommand("mkdir folder1"));
        assertEquals("Moved to directory: 'folder1'", fileSystem.executeCommand("cd folder1") );
